  ...
  return {
    ...
    content: [
      ...
      { text: 'Resumen de Servicios', style: 'sectionHeader', margin: [0, 14, 0, 6] },
      {
        ...
        layout: {
          fillColor: (rowIndex: number) => (rowIndex === 0 ? '#2f4f4f' : rowIndex % 2 === 0 ? '#f5f5f5' : null),
          hLineColor: () => '#e4e4e4',
          vLineColor: () => '#e4e4e4',
          hLineWidth: () => 1,
          paddingLeft: () => 6,
      ...
      { text: 'Cotización generada por Golden Garden.', style: 'notaTexto', margin: [0, 8, 0, 0] },
    ],
    styles: {
      header: { fontSize: 16, bold: true, color: '#1f3a1f' },
      subheader: { fontSize: 9, color: '#5d5d5d', margin: [0, 3, 0, 0] },
      titleRight: { fontSize: 20, bold: true, color: '#1f3a1f' },
      infoText: { fontSize: 9, color: '#4e4e4e', margin: [0, 3, 0, 0] },
      sectionHeader: { fontSize: 10.5, bold: true, color: '#1f3a1f', margin: [0, 8, 0, 4] },
      sectionValue: { fontSize: 9, color: '#3e3e3e', margin: [0, 2, 0, 2] },
      tableHeader: { fontSize: 9, bold: true, color: '#ffffff', fillColor: '#1f3a1f', margin: [0, 6, 0, 6] },
      tableCell: { fontSize: 9, color: '#333333', margin: [0, 3, 0, 3] },
      summaryLabel: { fontSize: 9, color: '#4f4f4f' },
      summaryValue: { fontSize: 9, bold: true, color: '#1f3a1f' },
      summaryTotal: { fontSize: 10, bold: true, color: '#1f3a1f', margin: [0, 4, 0, 4] },
      normalText: { fontSize: 9, color: '#4e4e4e', lineHeight: 1.3 },
      notaTexto: { fontSize: 8, italics: true, color: '#6f6f6f' },
    },
  };
}
